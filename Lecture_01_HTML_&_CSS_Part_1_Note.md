...
本篇笔记以 Ally 老师的 Lecture 01 HTML & CSS (Part 1) 为框架，根据 W3School 和 MDN 补充其他常见知识点和难点，旨在辅以 23 期全栈视频，帮助同学建立起基本的学习框架。
...
```
为什么语义化很重要？
- 提高代码可读性：使用语义化的标签可以使代码更加直观，帮助开发者和维护人员更容易理解页面结构和内容，从而提高开发效率。

- 提升SEO优化：搜索引擎通过爬虫程序分析网页内容，语义化的HTML标签有助于搜索引擎更准确地理解网页内容的结构和意义，从而提升网页在搜索引擎中的排名。

- 增强无障碍性：语义化的标签使得屏幕阅读器等辅助技术能够更好地解析网页内容，帮助有视觉障碍的用户更容易理解和导航网页，从而提升网页的无障碍性。
